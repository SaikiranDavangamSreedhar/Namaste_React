    ...
    return (
        <div className="body">
            ...
            <div className="res-container">
                {
                    resList.map((restaurant) => (<RestuarantCard key={restaurant.data.id} resData = {restaurant} />))
                }
                {/* <RestuarantCard resData= {resList.data.cards[4].card.card.gridElements.infoWithStyle.restaurants[0]} ></RestuarantCard>
                <RestuarantCard resData={resList.data.cards[4].card.card.gridElements.infoWithStyle.restaurants[1]}></RestuarantCard>
                <RestuarantCard resData={resList.data.cards[4].card.card.gridElements.infoWithStyle.restaurants[2]}></RestuarantCard>
                <RestuarantCard resData={resList.data.cards[4].card.card.gridElements.infoWithStyle.restaurants[3]}></RestuarantCard>
                <RestuarantCard resData={resList.data.cards[4].card.card.gridElements.infoWithStyle.restaurants[4]}></RestuarantCard>
                <RestuarantCard resData={resList.data.cards[4].card.card.gridElements.infoWithStyle.restaurants[5]}></RestuarantCard>
                <RestuarantCard resData={resList.data.cards[4].card.card.gridElements.infoWithStyle.restaurants[6]}></RestuarantCard> */}
